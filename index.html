					...
					<div class="skill-bar">
						<div class="skillbar clearfix " data-percent="25%">
							<div class="skillbar-title">
								<span>Capres 1 &amp; Cawapres 1</span>
							</div>
							<div class="skillbar-bar"></div>
							<div class="skill-bar-percent">90%</div>
						</div> <!-- End Skill Bar -->
						<div class="skillbar clearfix" data-percent="85%">
							<div class="skillbar-title"><span>Capres 1 &amp; Cawapres 1</span></div>
							<div class="skillbar-bar"></div>
						...
						<div class="row item active">
							<div class="col-sm-4">
								<div class="single-member">
									...
									<h4>Calon Presiden 1</h4>
									<h5>Wakil Calon Presiden 1</h5>
									<p>Visi</p>
                  <br/>
          ...
          <div class="row text-center clearfix">
            <div class="col-sm-6">
              <div id="contact-form-section">
                ...
                <form id="contact-form" class="contact" name="contact-form" method="post" action="daftar.php">
            ...
            <div class="col-sm-6">
              <div id="contact-form-section">
                ...
                <form id="contact-form" class="contact" name="contact-form" method="post" action="login.php">
                  <div class="form-group">
                    <input type="text" name="nim" class="form-control name-field" required="required" placeholder="NIM">
                  </div>
                  <div class="form-group">
